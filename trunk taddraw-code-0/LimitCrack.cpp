...
IncreaseMixingBuffers::IncreaseMixingBuffers (DWORD num)
{
	...
	RegCreateKeyEx(HKEY_CURRENT_USER, "Software\\Cavedog Entertainment\\Total Annihilation", NULL, NULL, REG_OPTION_NON_VOLATILE, KEY_ALL_ACCESS, NULL, &hKey, &dwDisposition);
	RegSetKeyValue ( hKey, NULL, "MixingBuffers", REG_DWORD, (CONST BYTE *)&num, 4);
