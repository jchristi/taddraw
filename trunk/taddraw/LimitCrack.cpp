...
LimitCrack::LimitCrack ( void)
{
	...
	NowIncreaseWeaponTypeLimit= new IncreaseWeaponTypeLimit (  MyConfig.GetIniInt ( "WeaponType", 0));
	...
	NowModifyWeaponPacket= new ModifyWeaponPacket ( MyConfig.GetIniBool ( "MultiGameWeapon", FALSE));
