...
{
	GUI0IDControl * UpperControl= GUIINFO_P->TheActive_GUIMEM->topControl;
...
{
	GUI0IDControl * UpperControl= (*TAmainStruct_PtrPtr)->desktopGUI.TheActive_GUIMEM->topControl;
...
int __stdcall ShareDialogProc (PInlineX86StackBuffer X86StrackBuffer)
{
	...
	GUI0IDControl * UpperControl= TAUI_p->TheActive_GUIMEM->topControl;
